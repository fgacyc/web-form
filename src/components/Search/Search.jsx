...
export default function Search() {
    ...
    const ministry_data = [{
        img: "src/assets/images/usher.png",
        cnMinistryTitle: "招待",
        ministryTitle: "Usher",
    ...
    },
    {
        ...
        img: "src/assets/images/software_development.png",
        ...
        img: "src/assets/images/content_creator.png",
        ...
        img: "src/assets/images/multimedia_design.png",
        ...
        img: "src/assets/images/stage_management.png",
    ...
    {
        img: "src/assets/images/multimedia.png",
        cnMinistryTitle: "多媒体",
    ...
    },
    {
        ...
        img: "src/assets/images/photography.png",
        cnMinistryTitle: "摄影",
        ...
        img: "src/assets/images/fashion_and_image.png",
    ...
    return (
        <section style={{ backgroundColor: "#f5f5f8" }} className="flex flex-col">
            <div className="flex" style={{ height: "24px", marginTop: "70px" }}>
                <img src="src/assets/icons/left.svg" alt="Back Icon" style={{ margin: "0px 35px" }} onClick={navigateBack}/>
                            ...
                            filteredData.map((ministry, index) => {
                                return (
                                    <SearchCard
                                        ...
                                        img={`src/assets/images/${ministry.ministryTitle.toLocaleLowerCase().replace(/\s/g, '_')}.png`}
