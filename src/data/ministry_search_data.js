...
export function getTeamAndSection(ministryTitle){
    for (let i = 0; i < ministry_search_data_list.length; i++) {
        if (ministry_search_data_list[i].ministryTitle === ministryTitle) {
            return {
                team: ministry_search_data_list[i].team,
                section: ministry_search_data_list[i].section
            }
        }
    }
}